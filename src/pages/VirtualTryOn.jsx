        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 h-full max-h-[600px] flex flex-col">
              ...
              <div className="overflow-y-auto grow space-y-4 pr-2">
              ...
              {selectedProduct && (
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <button className="w-full py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02]">
