...
const HealthVoiceAssistant = () => {
          ...
          <div className="text-center p-6 bg-blue-50 rounded-2xl border-2 border-blue-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button 
                ...
                className="px-6 py-3 bg-linear-to-r from-blue-500 to-teal-500 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-teal-600 transition-all duration-300 flex items-center justify-center"
              >
  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-cyan-50 via-blue-50 to-teal-100">
      {/* Header */}
      <header 
        ref={headerRef}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-linear-to-r from-blue-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div className="flex space-x-4">
              <button 
                ...
                className="px-6 py-3 bg-linear-to-r from-blue-500 to-teal-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-blue-600 hover:to-teal-600"
              >
                Get Started
              </button>
              <button 
                onClick={handleEmergencyContact}
                className="px-6 py-3 bg-linear-to-r from-red-500 to-pink-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-red-600 hover:to-pink-600 flex items-center"
              >
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          <h1 
            ref={titleRef}
            className="text-6xl md:text-7xl font-black mb-6 bg-linear-to-r from-blue-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent leading-tight"
          >
            Your Personal AI Health
            <span className="block bg-linear-to-r from-teal-500 to-blue-500 bg-clip-text text-transparent">
              Voice Assistant
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button 
              onClick={handleGetStarted}
              className="px-10 py-5 bg-linear-to-r from-blue-500 to-teal-500 text-white text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 hover:from-blue-600 hover:to-teal-600 group"
            >
        ...
        <section className="max-w-4xl mx-auto">
          <div 
            ref={widgetCardRef}
            className="bg-linear-to-r from-white to-blue-50 rounded-3xl shadow-2xl border-2 border-blue-200 p-8 hover:shadow-3xl transition-all duration-500 relative overflow-hidden"
          >
            {/* Glowing effect */}
            <div className="absolute -inset-1 bg-linear-to-r from-blue-400 to-teal-400 rounded-3xl blur opacity-20 group-hover:opacity-30 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
        ...
        <section className="max-w-4xl mx-auto mt-16">
          <div className="bg-linear-to-r from-blue-500 to-teal-500 rounded-3xl p-8 text-white shadow-2xl">
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-linear-to-r from-blue-400 to-teal-400 rounded-xl flex items-center justify-center">
            ...
            <div className="text-lg">
              <span className="bg-linear-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent font-semibold">
